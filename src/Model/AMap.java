...
public class AMap implements TowerSubject{
    private int listSize = 9;
    private List<ATower> towers = new ArrayList<ATower>();
    private ICreateObservable createTowerObserver;
    ...
    @Override
    public void addObserver(ICreateObservable observer) {
        createTowerObserver = observer;
    }

    @Override
    public void removeObserver(ICreateObservable observer) {
        createTowerObserver = null;
    }

    @Override
    public void notifyObservers(int x, int y, String type) {
